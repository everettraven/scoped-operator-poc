...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MemcachedState) DeepCopyInto(out *MemcachedState) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MemcachedState.
func (in *MemcachedState) DeepCopy() *MemcachedState {
	if in == nil {
		return nil
	}
	out := new(MemcachedState)
	in.DeepCopyInto(out)
	return out
}
